...
five_rating= Rating.query.filter(Rating.score=='5').all()
for rating in five_rating:
    print(rating)

movie_seven= Rating.query.filter(Rating.movie_id=='7').filter(Rating.user_id=='6').all()
for movie in movie_seven:
    print(movie)

good_movies= Rating.query.filter(Rating.score > 3).all()
